...
class String {
 ...
 public:
   ...
   * O(?)
   */
  unsigned int String::find(char*, int start = 0) const;
  unsigned int String::find(char, int start = 0) const;
